  ...
  return (
    <div className="p-8">
      ...
      <div className="flex flex-col gap-3 my-4">
        ...
        <Input
          placeholder="Name of you meeting event"
          ...
          {LocationOption.map((option, index) => (
            <div
              ...
              className={`border flex flex-col
                 ...
                 ${
                   (locationType == option.name) & "bg-green-100 border-black"
                 }`}
        ...
        <h2 className="font-bold">select the color </h2>
      ...
      <Button
        className="w-full "
        disabled={!eventName || !locationType || !locationUrl || !duration}
